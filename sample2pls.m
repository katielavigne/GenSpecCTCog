...
%       b. Regional CT - Specific Cognition (covary general cognition)
%       c. Global CT - General Cognition (covary mean thickness)
...
[data.cog_residmodel, ~, ~, data.cogresid] = ssregress(data.cog, data.glimfile, {'zGCI', 'Pre_Post_MRI'});
...
for i = 1:size(analysis_list,2)
    ...
    switch analysis_list{i}
        case 'GenCT-GenCog'
            covars = {'Pre_Post_MRI'};
            behvars = {'zVerbMem', 'zVisMem', 'zWorkMem', 'zProcSpeed', 'zExecFunc', 'zAtt', 'Full_Scale_IQ', 'Age', 'Gender', 'Handedness', 'Years_of_Education', 'SAPS_Total', 'SANS_Total_No_Att', 'CPZ_Adherence'};
        case 'GenCT-SpecCog'
            covars = {'Pre_Post_MRI'};
            behvars = {'zVerbMem_spec', 'zVisMem_spec', 'zWorkMem_spec', 'zProcSpeed_spec', 'zExecFunc_spec', 'zAtt_spec', 'Full_Scale_IQ', 'Age', 'Gender', 'Handedness', 'Years_of_Education', 'SAPS_Total', 'SANS_Total_No_Att', 'CPZ_Adherence'};
        case 'SpecCT-GenCog'
            covars = {'Pre_Post_MRI', 'meanCorticalMeasure20mm'};
            behvars = {'zVerbMem', 'zVisMem', 'zWorkMem', 'zProcSpeed', 'zExecFunc', 'zAtt', 'Full_Scale_IQ', 'Age', 'Gender', 'Handedness', 'Years_of_Education', 'SAPS_Total', 'SANS_Total_No_Att', 'CPZ_Adherence'};
        case 'SpecCT-SpecCog'
            covars = {'Pre_Post_MRI', 'meanCorticalMeasure20mm'};
            behvars = {'zVerbMem_spec', 'zVisMem_spec', 'zWorkMem_spec', 'zProcSpeed_spec', 'zExecFunc_spec', 'zAtt_spec', 'Full_Scale_IQ', 'Age', 'Gender', 'Handedness', 'Years_of_Education', 'SAPS_Total', 'SANS_Total_No_Att', 'CPZ_Adherence'};
